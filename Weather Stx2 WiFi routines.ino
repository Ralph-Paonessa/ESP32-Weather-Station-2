...
//		unsigned long timeStart = millis();
//
//		// XXX This is superfluous, because we always reset timer counts in this routine!!
...
//		if (isResetTimerCounts) {	// XXX This is superfluous, because we always reset timer counts in this routine!!
