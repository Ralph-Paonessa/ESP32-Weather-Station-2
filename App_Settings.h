...
namespace App_Settings {
	...
	*/
	...
	constexpr float VANE_OFFSET = 0;	// Degrees that wind direction reading exceeds true North.
	constexpr float WIND_DIRECTION_SPEED_THRESHOLD = 1;	// WindSpeed below which wind direction is not reported.
	constexpr float WIND_SPEED_OUTLIER_DELTA = 10;
	...
	////////////////////////constexpr char* dataPeriodName[] = { "10_MIN", "60_MIN", "DAY" };
